...
export const Curved = props => {
  ...
  return (
    <SVG corner={props.corner} viewBox="0 0 40 40">
      <path d="M0 30C5.52285 30 10 34.4772 10 40" />
      <path d="M0 20C11.0457 20 20 28.9543 20 40" />
      <path d="M0 10C16.5685 10 30 23.4315 30 40" />
      {background}
    </SVG>
  );
};
